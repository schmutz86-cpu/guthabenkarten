...
const productInfo: Record<string, Record<string, { usage: string; examples: string[] }>> = {
  de: {
    ...
    'spotify': { usage: 'Spotify Premium Guthaben schenkt dir werbefreies Musik-Streaming. Einlösbar für Spotify Premium Abos in der Schweiz.', examples: ['Spotify Premium Individual', 'Spotify Duo', 'Spotify Family', 'Spotify Student'] },
  ...
  en: {
    ...
    'spotify': { usage: 'Spotify Premium Credit gives you ad-free music streaming. Redeemable for Spotify Premium subscriptions in Switzerland.', examples: ['Spotify Premium Individual', 'Spotify Duo', 'Spotify Family', 'Spotify Student'] },
  ...
  fr: {
    'steam': { usage: 'Le crédit Steam est directement ajouté à votre Steam Wallet. Achetez des jeux PC, DLC, objets en jeu et logiciels dans le Steam Store.', examples: ['Skins Counter-Strike 2', 'Nouveaux jeux PC', 'DLC de jeux', 'Logiciels Steam'] },
    'playstation': { usage: 'Le crédit PlayStation Store charge votre PSN Wallet. Achetez jeux PS5/PS4/PS3, abonnements et contenus dans le PlayStation Store.', examples: ['Exclusivités PS5', 'PlayStation Plus', 'DLC de jeux', 'Monnaie en jeu'] },
    'xbox': { usage: 'Le crédit Xbox Live est crédité à votre Microsoft Account. Achetez jeux Xbox Series X|S, Game Pass et contenus dans le Microsoft Store.', examples: ['Xbox Game Pass', 'Jeux Xbox Series X', 'Xbox Live Gold', 'Objets en jeu'] },
    'nintendo': { usage: 'Le crédit Nintendo eShop charge votre Nintendo Account. Achetez jeux Switch, jeux indépendants et DLCs dans le Nintendo eShop.', examples: ['Jeux Super Mario', 'Zelda: BOTW/TOTK', 'Nintendo Switch Online', 'Jeux indépendants'] },
    'netflix': { usage: 'Les cartes cadeau Netflix peuvent être utilisées pour tout abonnement Netflix. Parfait pour offrir ou pour votre propre abonnement.', examples: ['Netflix Standard avec pubs', 'Netflix Standard', 'Netflix Premium 4K', 'Cadeau pour amis'] },
    'spotify': { usage: 'Le crédit Spotify Premium vous offre du streaming musical sans publicité. Utilisable pour les abonnements Spotify Premium en Suisse.', examples: ['Spotify Premium Individual', 'Spotify Duo', 'Spotify Family', 'Spotify Student'] },
    'apple': { usage: 'Le crédit Apple charge votre Apple ID. Achetez apps, jeux, musique, films, iCloud+ et plus dans l\'App Store et iTunes.', examples: ['Apps iPhone/iPad', 'Apple Music', 'Stockage iCloud+', 'Films Apple TV+'] },
    'google-play': { usage: 'Le crédit Google Play est crédité à votre Google Account. Achetez apps Android, jeux, films et livres dans le Play Store.', examples: ['Apps Android', 'Jeux mobiles', 'YouTube Premium', 'Stockage Google One'] },
    'roblox': { usage: 'Le crédit Roblox est converti en Robux. Achetez objets en jeu, accessoires avatar et fonctions premium dans Roblox.', examples: ['Robux (monnaie en jeu)', 'Vêtements avatar', 'Game passes', 'Roblox Premium'] },
    'amazon': { usage: 'Les bons Amazon.de peuvent être utilisés pour des millions de produits sur Amazon.de. Des trombones aux téléviseurs.', examples: ['Électronique', 'Livres & audiobooks', 'Articles ménagers', 'Adhésion Prime'] },
  },
  it: {
    'steam': { usage: 'Il credito Steam viene riscattato direttamente nel tuo Steam Wallet. Acquista giochi PC, DLC, oggetti in-game e software nello Steam Store.', examples: ['Skin Counter-Strike 2', 'Nuovi giochi PC', 'DLC di giochi', 'Software Steam'] },
    'playstation': { usage: 'Il credito PlayStation Store carica il tuo PSN Wallet. Acquista giochi PS5/PS4/PS3, abbonamenti e contenuti nel PlayStation Store.', examples: ['Esclusivi PS5', 'PlayStation Plus', 'DLC di giochi', 'Valuta in-game'] },
    'xbox': { usage: 'Il credito Xbox Live è accreditato al tuo Microsoft Account. Acquista giochi Xbox Series X|S, Game Pass e contenuti nel Microsoft Store.', examples: ['Xbox Game Pass', 'Giochi Xbox Series X', 'Xbox Live Gold', 'Oggetti in-game'] },
    'nintendo': { usage: 'Il credito Nintendo eShop carica il tuo Nintendo Account. Acquista giochi Switch, giochi indipendenti e DLC nel Nintendo eShop.', examples: ['Giochi Super Mario', 'Zelda: BOTW/TOTK', 'Nintendo Switch Online', 'Giochi indie'] },
    'netflix': { usage: 'Le carte regalo Netflix possono essere riscattate per qualsiasi abbonamento Netflix. Perfette per regalare o per il tuo abbonamento.', examples: ['Netflix Standard con pub', 'Netflix Standard', 'Netflix Premium 4K', 'Regalo per amici'] },
    'spotify': { usage: 'Il credito Spotify Premium ti offre streaming musicale senza pubblicità. Riscattabile per abbonamenti Spotify Premium in Svizzera.', examples: ['Spotify Premium Individual', 'Spotify Duo', 'Spotify Family', 'Spotify Student'] },
    'apple': { usage: 'Il credito Apple carica il tuo Apple ID. Acquista app, giochi, musica, film, iCloud+ e altro nell\'App Store e iTunes.', examples: ['App iPhone/iPad', 'Apple Music', 'Archiviazione iCloud+', 'Film Apple TV+'] },
    'google-play': { usage: 'Il credito Google Play è accreditato al tuo Google Account. Acquista app Android, giochi, film e libri nel Play Store.', examples: ['App Android', 'Giochi mobile', 'YouTube Premium', 'Archiviazione Google One'] },
    'roblox': { usage: 'Il credito Roblox viene convertito in Robux. Acquista oggetti in-game, accessori avatar e funzioni premium in Roblox.', examples: ['Robux (valuta in-game)', 'Abbigliamento avatar', 'Game passes', 'Roblox Premium'] },
    'amazon': { usage: 'I buoni Amazon.de possono essere riscattati per milioni di prodotti su Amazon.de. Dalle graffette ai televisori.', examples: ['Elettronica', 'Libri & audiolibri', 'Articoli domestici', 'Abbonamento Prime'] },
  },
};
...
export default function ProductDetail({ product }: { product: Product }) {
  ...
  const getDeliveryText = () => {
    switch (language) {
      case 'fr': return 'Délai de livraison';
      case 'it': return 'Tempo di consegna';
      case 'en': return 'Delivery time';
      default: return 'Lieferzeit';
    }
  };
  ...
  const getPaymentText = () => {
    switch (language) {
      case 'fr': return 'Paiement: Carte, Twint, PayPal';
      case 'it': return 'Pagamento: Carta, Twint, PayPal';
      case 'en': return 'Payment: Card, TWINT, PayPal';
      default: return 'Zahlung: Kreditkarte, TWINT, PayPal';
    }
  };

  const getHowItWorksText = () => {
    switch (language) {
      case 'fr': return 'Comment ça marche';
      case 'it': return 'Come funziona';
      case 'en': return 'How it works';
      default: return 'So funktioniert\'s';
    }
  };

  const getStepText = (step: number) => {
    const steps = {
      de: ['Wähle Menge und lege in den Warenkorb', 'Bezahle sicher mit TWINT oder Karte', 'Code kommt sofort in deine E-Mail'],
      en: ['Choose amount and add to cart', 'Pay securely with TWINT or card', 'Code arrives instantly via email'],
      fr: ['Choisissez le montant et ajoutez au panier', 'Payez en toute sécurité avec Twint ou carte', 'Le code arrive instantanément par email'],
      it: ['Scegli l\'importo e aggiungi al carrello', 'Paga in sicurezza con Twint o carta', 'Il codice arriva istantaneamente via email'],
    };
    return steps[language]?.[step - 1] || steps.de[step - 1];
  };
    ...
    <main className="pt-14">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
        <nav className="flex text-xs sm:text-sm text-slate-400 flex-wrap gap-1">
          <Link href="/" className="hover:text-white transition-colors">{getBackText()}</Link>
          ...
          <div className="bg-slate-800/50 backdrop-blur rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 border border-slate-700">
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-4 gap-2 sm:gap-3">
              <div className="bg-green-500/10 rounded-lg p-2 sm:p-3 text-center border border-green-500/20">
                ...
                <div className="text-green-400 text-[10px] sm:text-xs">{language === 'de' ? 'Sofort' : 'Instant'}</div>
              </div>
              ...
              <div className="bg-purple-500/10 rounded-lg p-2 sm:p-3 text-center border border-purple-500/20">
                ...
                <div className="text-purple-400 text-[10px] sm:text-xs">{language === 'de' ? 'Sicher' : 'Secure'}</div>
              </div>
              <div className="bg-yellow-500/10 rounded-lg p-2 sm:p-3 text-center border border-yellow-500/20">
                ...
                <div className="text-yellow-400 text-[10px] sm:text-xs">{language === 'de' ? 'Garantie' : 'Guarantee'}</div>
              </div>
            </div>
          </div>
          ...
          <div className="text-white space-y-4 sm:space-y-6">
            ...
            {product.denominations.length > 1 && (
              <div className="bg-slate-800/30 backdrop-blur rounded-xl p-4 sm:p-6 border border-slate-700">
                <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">{language === 'de' ? 'Betrag wählen' : 'Select amount'}</h2>
            ...
            <div className="bg-slate-800/50 backdrop-blur rounded-xl p-4 sm:p-6 border border-slate-700">
              <div className="flex items-center justify-between mb-3 sm:mb-4">
                <div>
                  <span className="text-3xl sm:text-4xl lg:text-5xl font-bold">CHF {selectedDenomination.toFixed(2)}</span>
                  <span className="text-lg sm:text-xl lg:text-2xl ml-1 sm:ml-2">CHF</span>
                </div>
                {product.inStock && (
                  <span className="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1 sm:py-2 bg-green-500/20 text-green-300 rounded-lg border border-green-500/30 text-xs sm:text-sm">
                    ...
                    <span className="hidden sm:inline">{language === 'de' ? '24/7 Verfügbar' : '24/7 Available'}</span>
            ...
            {info && (
              <div className="bg-slate-800/30 rounded-xl p-4 sm:p-6 border border-slate-700">
                <h2 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">{t.product.whatYouCanBuy || (language === 'de' ? 'Was du kaufen kannst' : 'What you can buy')}</h2>
                <p className="text-slate-300 text-xs sm:text-sm mb-3 sm:mb-4 leading-relaxed">{info.usage}</p>
                <h3 className="text-xs sm:text-sm font-semibold mb-2 text-slate-400">{t.product.examples || (language === 'de' ? 'Beispiele:' : 'Examples:')}</h3>
            ...
            <div className="bg-slate-800/30 rounded-xl p-4 sm:p-6 border border-slate-700 space-y-2 sm:space-y-3">
              <h2 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">{language === 'de' ? 'Lieferung & Sicherheit' : 'Delivery & Security'}</h2>
              ...
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 text-slate-300 text-xs sm:text-sm">
                ...
                <span>{getDeliveryText()}: {product.deliveryTime}</span>
              </div>
              ...
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 text-slate-300 text-xs sm:text-sm">
                ...
                <span>{language === 'de' ? 'Zustellung: Per E-Mail mit Anleitung' : 'Delivery: Via email with instructions'}</span>
              </div>
              ...
              <div className="flex items-start sm:items-center gap-2 sm:gap-3 text-slate-300 text-xs sm:text-sm">
                ...
                <span>{getRegionText()}: {product.region}</span>
              </div>
            ...
            {/* How it works */}
            <div className="bg-slate-800/30 rounded-xl p-4 sm:p-6 border border-slate-700">
              <h2 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">{getHowItWorksText()}</h2>
